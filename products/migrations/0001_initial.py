    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='NGN', max_digits=10, validators=[djmoney.models.validators.MinMoneyValidator(0.0)])),
                ('quantity', models.IntegerField(default=0)),
                ('color', models.CharField(blank=True, max_length=50)),
                ('size', models.CharField(blank=True, max_length=50)),
                ('weight', models.DecimalField(blank=True, decimal_places=2, max_digits=10, verbose_name='Weight in grams')),
